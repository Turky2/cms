                ...
                <div class="row">
                    <div class="my col-md-4">
                        <div class="contact-detail text-center">
                            <div class="icon">
                            <img src="{{asset('bootstrap/1.png')}}" style="width: 120px;height:100px"  />
                            </div>
                    ...
                    <div class="my col-md-4">
                        <div class="contact-detail text-center">
                            <div class="icon">
                                <img src="{{asset('bootstrap/e.png')}}" style="width: 120px;height:100px" />
                            </div>
                            <div class="content mt-4">
                    ...
                    <div class="my col-md-4">
                        <div class="contact-detail text-center">
                            <div class="icon">
                            <img src="{{asset('bootstrap/l.png')}}" style="width: 120px;height:100px" />
                            </div>
                            <div class="content mt-4">
...
<div class="elfsight-app-94660395-2300-455d-b082-80b861feee94" data-elfsight-app-lazy></div>
		...
		<!-- Start Appointment -->
		<section style="padding-bottom: 20px;" class="appointment">
  ...
  <button  class="buttonm btn btn-primary">ارسل</button>
</form>
            </div>
